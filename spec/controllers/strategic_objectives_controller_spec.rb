...
describe StrategicObjectivesController do
  ...
  describe "GET index" do
    ...
    describe "when none strategic objectives are registered" do
      ...
      it "should assign 'them' to @strategic_objectives" do
        StrategicObjective.should_receive(:get_all_for) { @strategic_objectives }
        get :index
        assigns(:strategic_objectives).should == @strategic_objectives
      end
