$(document).ready(function(){
  ...
  function add_input(type){
		...
		if(value!=""){
			...
			classs='light-gray';
			input="<div class='"+classs+"' id='operating_cycle_"+type+"_attributes_new_"+id+"_div'> <div class='left'><input type='text' size='50' name='operating_cycle["+type+"_attributes][new_"+id+"][name]' id='operating_cycle_"+type+"_attributes_new_"+id+"_name' class='"+type+"_input nested_textbox' value='"+value+"'></div>"
